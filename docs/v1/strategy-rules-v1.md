...
| D8 | Live timeframe | Not locked. Chosen by the owner after comparing Buy Limit frequency and outcomes on 15m/30m/1H (2026-09-25). One alert every 3–4 weeks (1H on 2026 data) is considered too sparse to decide on alone. **Owner, 2026-09-25 (after the 2015–2026 backtest): no live timeframe is selected.** Current results do not justify 15m, 30m or 1H for production. All three stay in the comparison; the decision is deferred until the Jev forward test (D11) has met its evaluation criteria. `alerts.liveTimeframe` in the config is a placeholder and is not used. |
